...
public class ImageViewerActivity extends AppCompatActivity implements OnTouchListener
{
	...
	// MENU SEND
	private static final int SEND_MODE = 500;
...
//		set up tool bar
		...
		// data passed from startActivity in ImageGridViewerActivity
...
//				Log.i(MYDEBUG,"IMG PATH: "+path);
	...
	private class MyGestureListener extends GestureDetector.SimpleOnGestureListener
	{
		...
		{
			Log.i("MYDEBUG","zoomMode at onDoubleTap"+String.valueOf(zoomMode));
