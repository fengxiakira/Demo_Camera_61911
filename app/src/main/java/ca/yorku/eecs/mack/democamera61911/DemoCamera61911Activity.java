 ...
 *
 * Login ID - lmy03
 * Student ID - 216161911
 * Last name - Li
 * First name(s) - Mengyuan
 */

public class DemoCamera61911Activity extends Activity implements OnClickListener, OnTouchListener
{
...
//        imageCameraButton.setBackgroundColor(Color.WHITE);
//        imageCameraButton.getBackground().setAlpha(180);
        setButtonBackgroundColor(imageCameraButton);
        setButtonBackgroundColor(videoCameraButton);
        setButtonBackgroundColor(imagePrevButton);
        setButtonBackgroundColor(imageNextButton);
        setButtonBackgroundColor(videoPrevButton);
        setButtonBackgroundColor(videoNextButton);
    ...
    private void setButtonBackgroundColor(ImageButton b)
    {
    ...
    public boolean onTouch(View v, MotionEvent me)
    {
        ...
        if (v == imageView && imageFilenames.length > 0)
        {
            ...
            Intent i = new Intent(getApplicationContext(), ImageGridViewerActivity.class);
            i.putExtras(b);
